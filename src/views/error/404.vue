 ...
 <template>
  <div>
    <Header />
    <div class="wscn-http404-container text-left">
      <div class="wscn-http404">
        ...
        <div class="bullshit">
          ...
          <div class="bullshit__headline">网页找不到了</div>
          <div class="bullshit__info">请检查您复制的网址是否正确,或者点击返回按钮返回到工作台</div>
          <div class="bullshit__return-home" @click="back">返 回</div>
        </div>
      </div>
    </div>
  </div>
